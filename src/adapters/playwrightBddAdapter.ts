...
export class PlaywrightBddAdapter implements IBddAdapter {
    ...
    private getRunArgs(request: vscode.TestRunRequest, run: vscode.TestRun): string[] {
        ...
        if (request.include && request.include.length > 0) {
            ...
            // NOTE: We do NOT pass .feature file paths to Playwright.
            // Playwright only understands .spec.ts files (generated by bddgen).
            // The --grep argument alone is sufficient to target specific scenarios.
        }
        return args;
    }
